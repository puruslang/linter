...
[Issue](https://github.com/puruslang/linter/issues) を作成し、以下を記載してください：
...
このプロジェクトは[行動規範 (Code of Conduct)](https://github.com/puruslang/linter/blob/main/CODE_OF_CONDUCT-ja.md) に従っています。参加することで、この規範を守ることが求められます。

## ライセンス

貢献していただいたコードは [Apache 2.0 ライセンス](https://github.com/puruslang/linter/blob/main/LICENSE) のもとで公開されます。
